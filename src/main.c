...
int main(gint argc, gchar * argv[])
{
    ...
    g_spawn_sync(NULL, av1, NULL, G_SPAWN_SEARCH_PATH, NULL, NULL, &stdout, &stderr, &exit_status,
                 &error);
    if (error != NULL) {
    ...
    if (error != NULL) {
        ...
        g_spawn_async_with_pipes(NULL, av3, NULL, G_SPAWN_SEARCH_PATH | G_SPAWN_STDERR_TO_DEV_NULL,
                                 NULL, NULL, &pid, NULL, &fhout, NULL, &error);
            ...
            if (error != NULL) {
                ...
                if (verbose) {
                    ...
                    printf("scaling to %i x %i\n",
                           238 * gdk_pixbuf_get_width(pb_prescale) /
                           gdk_pixbuf_get_height(pb_prescale), 238);
                }
                ...
                output = gdk_pixbuf_new(gdk_pixbuf_get_colorspace(pb),
                                        ...
                                        gdk_pixbuf_get_width(pb_right), gdk_pixbuf_get_height(pb));
                ...
                gdk_pixbuf_copy_area(pb_right,
                                     ...
                                     output,
                                     gdk_pixbuf_get_width(pb_left) + gdk_pixbuf_get_width(pb), 0);
                ...
                if (verbose) {
                    ...
                    printf("scaling to %i x %i\n",
                           size,
                           size * gdk_pixbuf_get_height(output) / gdk_pixbuf_get_width(output));
                }

                scaled = gdk_pixbuf_scale_simple(output,
                                                 size,
                                                 size * gdk_pixbuf_get_height(output) /
                                                 gdk_pixbuf_get_width(output), GDK_INTERP_BILINEAR);
        ...
        if (verbose) {
            ...
            printf("scaling to %i x %i\n", size,
                   size * gdk_pixbuf_get_height(pb) / gdk_pixbuf_get_width(pb));
        }

        scaled = gdk_pixbuf_scale_simple(pb,
                                         size,
                                         size * gdk_pixbuf_get_height(pb) /
                                         gdk_pixbuf_get_width(pb), GDK_INTERP_BILINEAR);
